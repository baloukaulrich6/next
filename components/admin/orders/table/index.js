  ...
  return (
    <React.Fragment>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell align="right">{row.paymentMethod == "orangeMoney" ? "Orange Money"
        : row.paymentMethod == "credit" ? "Credit Card"
        : "Cash" }</TableCell>
        <TableCell align="right">{row.isPaid ?( <img src="../../../images/verified.png" alt="" className={styles.ver}/>): 
              ...
              <Table size="small" aria-label="purchases">
                ...
                <TableBody>
                    ...
                    <TableRow key={row.user.id}>
                      ...
                      {row.shippingAddress.phoneNumber1} <br />
                      {row.shippingAddress.phoneNumber2} <br />
                      </TableCell>
                    </TableRow>
                ...
                <TableBody>
                  {row.products.map((p) => (
                    <TableRow key={p._id}>
                      ...
                      <TableCell align="left">{p.price} FCFA</TableCell>
                    </TableRow>
                  ))}
                  <TableRow key={row._id}>
                    ...
                    >
                      <b style={{ fontSize: "20px" }}>{row.total} FCFA</b>
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
